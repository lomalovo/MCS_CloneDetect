...
public class HelloWorldSelectedPages {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            stamper = new PdfStamper(reader, new FileOutputStream("results/in_action/chapter02/HelloSelectedOdd.pdf"));
            reader.selectPages("o");
            stamper.close();
            reader = new PdfReader("results/in_action/chapter02/HelloWorldMultiplePages.pdf");
            stamper = new PdfStamper(reader, new FileOutputStream("results/in_action/chapter02/HelloSelectedEven.pdf"));
            reader.selectPages("e");
            stamper.close();
            reader = new PdfReader("results/in_action/chapter02/HelloWorldMultiplePages.pdf");
            stamper = new PdfStamper(reader, new FileOutputStream("results/in_action/chapter02/HelloSelected12379.pdf"));
