...
public class Peace extends DefaultHandler {
    ...
    public Peace() {
        fs = new FontSelector();
        fs.addFont(FontFactory.getFont("c:/windows/fonts/arialuni.ttf", BaseFont.IDENTITY_H, BaseFont.EMBEDDED));
        fs.addFont(FontFactory.getFont("resources/in_action/chapter09/abserif4_5.ttf", BaseFont.IDENTITY_H, BaseFont.EMBEDDED));
        fs.addFont(FontFactory.getFont("resources/in_action/chapter09/damase.ttf", BaseFont.IDENTITY_H, BaseFont.EMBEDDED));
        fs.addFont(FontFactory.getFont("resources/in_action/chapter09/fsex2p00_public.ttf", BaseFont.IDENTITY_H, BaseFont.EMBEDDED));
