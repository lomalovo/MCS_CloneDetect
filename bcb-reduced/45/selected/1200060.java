...
public class VisibleSignatureDialog extends javax.swing.JDialog {
   ...
   */
    ...
    public VisibleSignatureDialog(java.awt.Frame parent, boolean modal, final BasicSignerOptions anOptions, final SignerFileChooser aFC) {
        super(parent, modal);
        options = anOptions;
        fc = aFC;
        ...
        selectionImage.getRelRect().addPropertyChangeListener(new PropertyChangeListener() {
            ...
            public void propertyChange(PropertyChangeEvent evt) {
                if (previewListenerDisabled) return;
   ...
   */
    ...
    private void chkbAcro6LayersActionPerformed(java.awt.event.ActionEvent evt) {
    }
    ...
    private void btnPreviewCloseActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (pageNr != null) {
            ...
            if (buffImg != null) {
                ...
                try {
                    ...
                    tmpRect.setStartPoint(new FloatPoint(Float.parseFloat(tfPosLLX.getText()) / pdfPageSize.getX(), 1f - Float.parseFloat(tfPosLLY.getText()) / pdfPageSize.getY()));
                    tmpRect.setEndPoint(new FloatPoint(Float.parseFloat(tfPosURX.getText()) / pdfPageSize.getX(), 1f - Float.parseFloat(tfPosURY.getText()) / pdfPageSize.getY()));
                } catch (Exception e) {
                }
    ...
    private void btnBgImgPathBrowseActionPerformed(java.awt.event.ActionEvent evt) {
        fc.showFileChooser(tfBgImgPath, null, JFileChooser.OPEN_DIALOG);
    }

    private void btnImgPathBrowseActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void chkbL4TextDefaultActionPerformed(java.awt.event.ActionEvent evt) {
        tfL4Text.setEnabled(!chkbL4TextDefault.isSelected());
    }

    private void chkbL2TextDefaultActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void cbDisplayModeActionPerformed(java.awt.event.ActionEvent evt) {
        switchImage();
    }
