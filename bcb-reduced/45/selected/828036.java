package eu.ictromulus.segovia.reports;
...
import eu.ictromulus.segovia.data.SegoviaStatistics;
import eu.ictromulus.segovia.graphics.ChartGenerator;
...
/**
 * Creates a PDF report from the input statistics.
 *
 * @author Alberto Pastor Nieto
 */
public class PDFReportGenerator extends ReportGenerator {
     ...
     * Image Height.
     */
    private static final Integer IMAGE_HEIGHT = 200;

    /**
     * Background color.
     */
    private static final int BG_COLOR = 0xFF;
    ...
    @Override
    protected String createFooter(final String outputFile) {
        return "";
    }
}
