...
public class HtmlMovies2 extends HtmlMovies1 {
    ...
    public static class MyImageFactory implements ImageProvider {
        ...
        public Image getImage(String src, Map<String, String> h, ChainedProperties cprops, DocListener doc) {
            try {
                return Image.getInstance(String.format("resources/posters/%s", src.substring(src.lastIndexOf("/") + 1)));
    ...
    public static final String RESULT1 = "results/part3/chapter09/html_movies_2.pdf";

    /** Another resulting PDF file. */
    public static final String RESULT2 = "results/part3/chapter09/html_movies_3.pdf";
