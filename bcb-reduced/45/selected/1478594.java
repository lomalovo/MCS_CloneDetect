...
public class FoxDogGeneric3 extends PdfPageEventHelper {
	 ...
	 */
    private static void create_0(Document document, IndexEvents index) throws DocumentException {
	 ...
	 * @throws DocumentException
	 */
    private static void create_1(Document document, IndexEvents index) throws DocumentException {
	 ...
	 * @throws DocumentException
	 */
    private static void create_2(Document document, IndexEvents index) throws DocumentException {
        Paragraph p = new Paragraph();
	 ...
	 * @throws DocumentException
	 */
    private static void create_3(Document document, IndexEvents index) throws DocumentException {
        Paragraph p = new Paragraph();
